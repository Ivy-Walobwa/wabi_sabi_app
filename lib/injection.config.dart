...
import 'domain/auth/auth_facade_interface.dart' as _i5;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i5.AuthFacadeInterface>(() =>
      _i6.FirebaseAuthFacade(get<_i3.FirebaseAuth>(), get<_i4.GoogleSignIn>()));
  gh.factory<_i7.SignInFormBloc>(
      () => _i7.SignInFormBloc(get<_i5.AuthFacadeInterface>()));
  gh.factory<_i8.AuthBloc>(() => _i8.AuthBloc(get<_i5.AuthFacadeInterface>()));
  return get;
}
